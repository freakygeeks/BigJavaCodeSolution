...
public class TwoCircleIntersectTestViewer
{
	...
	String input6 = JOptionPane.showInputDialog("Please enter radius for second circle");
	double r2 = Double.parseDouble(input6);
	
	TwoCircleIntersectTest calc = new TwoCircleIntersectTest(x1, y1, r1, x2, y2, r2);
	frame.add(calc);
